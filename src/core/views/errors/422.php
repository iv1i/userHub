...
<body class="error-422">
<div class="error-decoration decoration-1">📝</div>
<div class="error-decoration decoration-2">✏️</div>

<div class="error-container">
    <div class="error-icon"></div>
    <h1 class="error-code">422</h1>
    <h2 class="error-message">Validation Error</h2>
    <p class="error-description">
        There were errors with your submission. Please check the information below.
    </p>

    <?php if ($exception instanceof \core\exceptions\ValidationException): ?>
    ...
    <div class="error-actions">
        <a href="javascript:history.back()" class="btn btn-primary">Go Back to Fix</a>
